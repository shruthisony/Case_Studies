...
-- TYPE YOUR CODE BELOW:
SELECT A.ID_C - A.ID_DC AS NULL_COUNT FROM (
SELECT COUNT(ID) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
UNION ALL
SELECT COUNT(TITLE) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
UNION ALL
SELECT COUNT(YEAR) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
UNION ALL
SELECT COUNT(DATE_PUBLISHED) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
UNION ALL
SELECT COUNT(DURATION) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
UNION ALL
SELECT COUNT(COUNTRY) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
UNION ALL
SELECT COUNT(WORLWIDE_GROSS_INCOME) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
UNION ALL
SELECT COUNT(LANGUAGES) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
UNION ALL
SELECT COUNT(PRODUCTION_COMPANY) AS ID_DC, COUNT(*) AS ID_C FROM MOVIE
) A;

-- COUNT(*) GIVES THE TOTAL NO OF COUNTS IN THE COLUMN INCLUDING NULLS
-- COUNT(COLNAME) GIVES THE TOTAL NO OF COUNTS IN THE COLUMN EXCLUDING NULLS
...
SELECT YEAR,COUNT(ID) AS NUM_OF_MOVIES FROM MOVIE WHERE (COUNTRY LIKE '%INDIA%' OR COUNTRY LIKE '%USA%')  AND YEAR = 2019;
...
SELECT GENRE,COUNT(MOVIE_ID) AS NUM_OF_GENRE FROM GENRE
GROUP BY GENRE
...
SELECT A.ID_C - A.ID_DC AS NULL_COUNT FROM (
SELECT COUNT(NAME) AS ID_DC, COUNT(*) AS ID_C FROM NAMES
UNION ALL
SELECT COUNT(HEIGHT) AS ID_DC, COUNT(*) AS ID_C FROM NAMES
UNION ALL
SELECT COUNT(DATE_OF_BIRTH) AS ID_DC, COUNT(*) AS ID_C FROM NAMES
UNION ALL
SELECT COUNT(KNOWN_FOR_MOVIES) AS ID_DC, COUNT(*) AS ID_C FROM NAMES 
) A;
...
SELECT A.*, DENSE_RANK() OVER (ORDER BY A.ACTOR_AVG_RATING DESC) AS ACTOR_RANK FROM ( 
...
HAVING COUNT(DISTINCT A.MOVIE_ID) >= 5) A
LIMIT 1;
...
SELECT A.*, DENSE_RANK() OVER(ORDER BY A.ACTRESS_AVG_RATING DESC) AS ACTRESS_RANK FROM (
...
GROUP BY N.NAME HAVING COUNT(DISTINCT M.ID) >=3) A
LIMIT 5;
...
SELECT A.*,RANK() OVER(ORDER BY MOVIE_COUNT DESC) AS ACTRESS_RANK FROM 
(
